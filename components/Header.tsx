...
import { Search, Bell, Sparkles, HelpCircle, ArrowRight, UserCheck, ShieldCheck, MessageSquare } from "lucide-react";
      ...
      <header className="h-16 bg-white/80 backdrop-blur-md border-b border-slate-200/80 sticky top-0 z-20 px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 w-80 lg:w-96">
          <div
            ...
            className="relative w-full bg-slate-100/70 hover:bg-slate-100 border border-slate-200/60 rounded-xl px-3.5 py-1.5 flex items-center justify-between cursor-pointer transition-colors group"
          >
            <div className="flex items-center gap-2 text-xs text-slate-400 group-hover:text-slate-600">
              ...
              <span className="truncate">Soliq Kodeksi, hujjatlar yoki moliyaviy ma'lumotlarni qidirish...</span>
            </div>
            <kbd className="bg-white border border-slate-200 rounded px-1.5 text-[10px] text-slate-400 font-mono shrink-0">
              ⌘K
            </kbd>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 relative">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-xs font-medium px-3.5 py-2 rounded-xl shadow-sm shadow-blue-600/20 transition-all hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
          >
          ...
          <button
            ...
            className={`flex items-center gap-2.5 px-3 py-1.5 rounded-xl border text-xs font-semibold transition-all shadow-2xs group cursor-pointer ${
              role === "director"
          ...
          >
            <div
              className={`w-6.5 h-6.5 rounded-lg text-white font-bold text-[10px] flex items-center justify-center ${
            ...
            <UserCheck className="w-3.5 h-3.5 text-slate-400 group-hover:text-slate-600 ml-0.5" />
          </button>
